        ...
        <div class="row justify-content-center mt-40">
          <div class="col-md-6">
            ...
            <form role="search" method="get" class="search-form relative">
              <input
                type="search"
                class="widget-search-input mb-0"
                placeholder="Search an article"
              />
              <button type="submit" class="widget-search-button btn btn-color">
                <i class="ui-search widget-search-icon"></i>
              </button>
            </form>

            <!-- Back to home -->
            <a href="index-2.html" class="btn btn-lg btn-light mt-40"
